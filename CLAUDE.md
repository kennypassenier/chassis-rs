...
| Next action | waiting on Kenny: the resume form of 2026-09-26 (release 2.1.0, CT 118 drill wiring, kyu-runner's kept list, corrections fix-7 and fix-8). Done that day on WSL: fix-7 (the minisign prompt), fix-8 (the suite on WSL2), CF-12 closed on Almanac's measurement. Still blocked: batch 5, fix-3, helper units, h7 passkeys — see the 2026-09-26 section of docs/PENDING_MINI_ROUNDS.md |
